...
sr.reveal(".nav__item, .home__social-icon, .skill-boxes", {
  interval: 200,
});

sr.reveal(".skills__data, .work__img, .contact__input, .footer__title", {
  interval: 200,
});

ScrollReveal().reveal(".button,  .footer__social i", {
  delay: 200,
  distance: "-100px",
  duration: 1000,
  // easing: "ease-in-out",
